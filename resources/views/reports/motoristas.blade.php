<!-- resources/views/reports/motoristas.blade.php -->
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <table>
        ...
        <tbody>
            @forelse($report['data'] as $motorista)
            <tr>
    ...
    <div class="footer">
        Relatório de Motoristas - Total de Registros: {{ $report['total'] ?? 0 }}
    </div>
</body>
</html>